...
const EMOJI_GAME_URL = 'https://emoji-kitchen.emojis.click/en';
...
// 动态导入帮助中心和FAQ，导入具名导出
const DynamicHelpCenter = dynamic(() => import('@/components/iframes/emoji-kitchen-game/help').then(mod => mod.default), {
  ssr: false,
  loading: () => <div className='h-32 animate-pulse bg-gray-100 rounded-lg' />
});

const DynamicFAQ = dynamic(() => import('@/components/iframes/emoji-kitchen-game/faq').then(mod => mod.default), {
  ssr: false,
  loading: () => <div className='h-32 animate-pulse bg-gray-100 rounded-lg' />
});
